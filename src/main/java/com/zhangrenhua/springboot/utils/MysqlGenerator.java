package com.zhangrenhua.springboot.utils;
...
public class MysqlGenerator {
	...
	private static final String PACKAGE_NAME = "com.zhangrenhua";
    private static final String MODULE_NAME = "springboot";
	private static final String OUT_PATH = "/Users/zhangrenhua/my/workspace/code";
	private static final String AUTHOR = "zhangrenhua";
							...
							public void initMap() {
								...
								Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/mapper.xml.vm") {
									...
									public String outputFile(TableInfo tableInfo) {
										return OUT_PATH + "/" + tableInfo.getEntityName() + "Mapper.xml";
									}
								})))
				.setTemplate(
